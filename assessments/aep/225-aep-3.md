...
You probably learned how to find the GCD of two numbers in elementary school by *factoring* the two numbers and looking for common factors that way. My kids learned this by making a "factor tree" like this: 

![enter image description here](https://i.ibb.co/NN2NdHk/download.jpg)

("GCF" means the same thing as "GCD".) 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDI2MDI0OTZdfQ==
-->