...
- Task 1 must show all Extended Euclidean Algorithwork in a clear, organized, and legible manner, and the GCD must be clearly indicated. 

A grade of "E" is given if all of the above expectations are met, and the work is of superior quality in terms of the clarithy of explanations and work, appearance of the writeup, and precision of the mathematics. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzNDkyNzIwN119
-->