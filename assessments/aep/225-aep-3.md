...
3. An interesting and highly useful feature of GCD's is that the GCD of two integers can always be expressed as combination of the two integers themselves. For example, $\gcd(20,32) = 4$ and notice that $$4 = 20(-3) + 32(2)$. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODYyMTE2MTBdfQ==
-->