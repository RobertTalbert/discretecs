...
3. An interesting and highly useful feature of GCD's is that the GCD of two integers can always be expressed as combination of the two integers themselves.  In general, if $\gcd(a,b) = n$, then there are integers $x$ and $y$ such that $ax + by = n$. For example, $\gcd(20,32) = 4$ and notice that $4 = 20(-3) + 32(2)$. Another example: $\gcd(1970, 2020) = 10$, and notice $1970
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMzk2NjQyNjBdfQ==
-->