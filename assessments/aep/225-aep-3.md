...
Through our study of modular arithmetic, we've seen that division of integers is both useful in applications and yet tricky in terms of actual computation. For example, say we want to compute `189123 % 26`. We have to divide 189123 by 26 and keep the remainder. But how does a computer know how to do that? Even if we just grab a calculator and enter in $189123 \div 26$, and get 7273.96153846153846, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI4NzU5OTgyMF19
-->