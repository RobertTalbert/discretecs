...
+ `to_set`: This function accepts a list and returns a modified version of that list that still is of the `list` data . Examples:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyNjY2MzU2N119
-->