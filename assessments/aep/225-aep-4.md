...
3. In the AEP assignment, paste the link as "Submission text". There will be no file to upload this time; all I need is the link.  

**Note: This process is different than sharing the notebook with just me, as many of you did with the Python/Jupyter crash course.** It turns out that sharing the notebook with just me, the email to me that contains the link ended u  to me that 90% of the time ends up in my spam folder. So, **please do it this way or I will probably not see your submission.** 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDQxNDc1NzgsMTg2NzIyNzg1MV19
-->