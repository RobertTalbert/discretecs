...
In your Algebra 1 class back in middle school or high school, you learned how to solve basic equations involving multiplication, like $3x = 1$. It's simple --- just divide both sides by 3 to get $x = 1/3$. What if we wanted to extend this idea to equations involving the modulus operator, like this
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTgyMzc3MzNdfQ==
-->