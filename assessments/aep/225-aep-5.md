...
But that doesn't make sense because $1/3$ isn't an integer. Instead, we need to find an *integer* $x$ that, when substituted in, t
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNjI3NTcwOTVdfQ==
-->