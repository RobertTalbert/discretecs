...
Having found an integer $x$ such that $3x \ \% \ 7 = 1$ --- namely $x =5$ --- we can stop because we've solved the equation. 

But notice that for some moduli, this equation may be impossible to solve. For example, if we were given the equation $3x \ \% \ 6 = 0$ instead, then look what happens: 
...
...and so on. The value of $3x \ \% \ 6$ will just alternate between 0 and 3, because when you multip
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE5OTUwMjM1M119
-->