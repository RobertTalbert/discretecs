...
>**This AEP requires that you be familiar with the Euclidean Algorithm and Extended Euclidean Algorithm from AEP 3.** While *completing* AEP 3 is not a requirement for AEP 5, fluency with these two algorithms is. 

In AEP 3, we learned about the **greatest common divisor** of two positive integers and how to use
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTIwNDQyNDRdfQ==
-->