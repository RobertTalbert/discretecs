...
In this AEP, you'll learn how to use the Extended Euclidean Algorithm to solve modular equations of the form $ab \ \% \ n = 1$ and explore the applications of this idea to crypograp
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA3OTcyNDU1Nl19
-->