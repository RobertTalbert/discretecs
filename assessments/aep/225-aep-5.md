...
4. Now let's think about how we might find $a^{-1} \ \% \ n$ more efficiently than a brute-force search. 

   a) Suppose there are integers $x,y$ such that $ax + ny = 1$. (For example, if $a = 3$ and $n = 7$, then 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODE1NTE2MTBdfQ==
-->