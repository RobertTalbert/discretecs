...
In this AEP, you'll be working through a section of the text that covers another method, which applies when the differences in the terms of the sequences obey a certain pattern. 
...
| Fourth differences | $0, 0, 0, 0, \dots$ | 

What we see here is that **the sequence of third differences is constant** --- all the terms are the same. All of the fourth, fifth, etc. differences will be 0 because the third differences are constant. In the triangular numbers, the sequence of second differences was constant. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzOTY0MDEyNywtMTYxNTU2MDM4OV19
-->