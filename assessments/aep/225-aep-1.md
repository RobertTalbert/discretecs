...
Note, some implementations of this cipher include an extra step: Before sending the encrypted message, convert the 8-bit strings in the ciphertext to ASCII and send those. However this sometimes leads to characters that can't be vis

For example the encrypted message `10010001 10010110 10001101` would be three asc
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA2NDY5NTE3MV19
-->