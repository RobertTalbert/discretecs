...
2. Convert each letter into its **ASCII decimal** format. ASCII is a standard means of encoding characters into integers. You can find tables of ASCII values on the web, [for example here](http://www.asciitable.com/); 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODAwNTE3NjddfQ==
-->