...
So this is like regular binary addition except **we don't every carry a 1**. Ordinary addition would say `1 + 1 = 10` but here, `1 xor 1` is just `0`. This means that 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTE5MDkwODY0XX0=
-->