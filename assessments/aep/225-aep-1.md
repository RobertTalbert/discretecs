...
**Option 1: For the coders.** Write a Python function that implements the XOR cipher. This function, which you are to call `xor_cipher`, should accept a string as i
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzQyMjQ4Mjk5XX0=
-->