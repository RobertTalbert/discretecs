...
**Option 1: For the coders.** Write two Python functions: One called `xor_encrypt` that implements the XOR cipher encryption step, and another called `xor_decrypt` that implements the XOR cipher decryption step. The `xor_encrypt` function should take in a string of characters as input and produce the binary 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjIxMjQyMTM2XX0=
-->