...
However, you suspect that the binary string `10001111` in the ciphertext was originally the letter `E` in the plaintext, since `E` is the most commonly occurring letter in the alphabet and this string `10001111`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzOTk2NzQ0ODldfQ==
-->