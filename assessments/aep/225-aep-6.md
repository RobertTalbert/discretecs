...
3. Suppose we again have of ten memory cells $c_1, c_2, \dots, c_{10}$ and seven data items labelled $d_1, d_2, \dots, d_7$ to be stored in the cells. But now suppose that 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2Mzc0NTY4NDMsMTg4ODA5NDIyOSwtMT
YzNTk1NzU2MF19
-->