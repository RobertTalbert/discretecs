...
**Example of the previous step:** Alice wants to send the message `AM ON MY WAY`. Converting this to integers 00-25 gives `00 12 14 13 12 24 22 00 24` and stripping out the spaces gives `001214131224220024`. Bob's value of $n$ is 237733. So Alice breaks her message up into blocks less than 237733 --- for example, into blocks four digits long: `0012 1413 1224 2200 24`. To get that last block exactly four digits, she pads it with a couple of zeroes to get `0012 1413 1224 2200 2400`

The encryption step continues as follows: 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxNDk5NjAxNSwzMzE1NzM1NDYsNDgxMj
kzODQ5XX0=
-->