...
- Then the user does four computations: 
	...
	- $e = AM + a$
	- $d = BM + b$
	- $n = \frac{ed}{M}$ which equals $ABM + aB + Ab + 1$
...
- Alice takes her plaintext message --- which for this AEP we will assume is just a string of capital letters without punctuation or other symbols --- converts each letter to numbers $00$ through $25$ according to its position in 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzQ4MzU4ODIsNDgxMjkzODQ5XX0=
-->