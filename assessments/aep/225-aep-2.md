...
**Option 2: For hackers.** Choose someone on the public key spreadsheet, and using only their public key information, figure out their private key. How you do this is up to you. You can use math, or a computer program you write, or some combination. You may not torture the person to get their information; you may also not engage in social engineering (i.e. y


Using only the public keys on the spreadsheet, figure out someone else's private key. If you can do this, you will demonstrate that while this cryptosystem is a nice example of public key encryption, it's highly vulnerable to attack by an adversary (that's you). Any situation where the private information can be recovered relatively straightforwardly from the public information, is bad. **Please note:** To deter cheating on this, each person needs to hack a different person. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzE0NDE3MDMyLDMzMTU3MzU0Niw0ODEyOT
M4NDldfQ==
-->