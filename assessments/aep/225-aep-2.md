...
- `pk_keys` which takes in four positive integers from the user and generates the public and private keys for the system. The function should use `return` and not `print` for the output. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODAxNzM5NCwzMzE1NzM1NDYsNDgxMj
kzODQ5XX0=
-->