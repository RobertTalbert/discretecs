...
- ...Sharing the key for encryption and decryption was problematic? For example, what I believed that "Eve" might be eavesdropping on the channel I am using to send you the key? I could encrypt the key, but that doesn't solve the problem because how will I get you the second key that encrypts the first one, in a way that convinces me Eve hasn't stolen it or tampered with it? The Diffie-Hellman protocol we studied in Module 2 solves this problem
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMzEyNzQ4OTQsNDgxMjkzODQ5XX0=
-->