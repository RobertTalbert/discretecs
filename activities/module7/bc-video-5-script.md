...
Now let's look at something that on the surface appears completely different -- taking the algebraic expression x+y and raising it to the nth power. When n = 0, 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxMzA3NDg5MiwtODM1MzUzOTkwXX0=
-->