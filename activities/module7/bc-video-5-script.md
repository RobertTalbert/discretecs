...
Watch what happens as we take the powers higher. Let's look at (x+y)^5. when fully expanded it looks like this. Now, check out the coefficients on the terms. The coefficient on the x^5 and y^5 terms are 1. The coefficients on the x^4y and xy^4 terms are 5 and the coefficients on the 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ4NTY1MTYzMCwtNzEyNDE0NjA4LC04Mz
UzNTM5OTBdfQ==
-->