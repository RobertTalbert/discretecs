...
Remember how we said there are some questions we should ask about algorithms when we see them: Why does this work? Do we know it always produces a correct result? Do we know it always terminates? You would be justified in wondering about these questions for long division, mainly because in school nobody ever talks about these, and at this point a grown-up understanding of math demands some answers. I hate to keep doing this, but to really understand not just HOW to do long division but WHY the long division algorithm works, you'll have to keep traveling through the course, as we pick up tools that will make it easier to think about those questions. But spoiler alert, in the next video we're going to begin to explain things. 
