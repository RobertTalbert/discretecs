...
+ The syllabus is available in electronic form and as a PDF. The electronic version will be consistently updated as needed, with updates noted **in boldface, like this**. *The PDF version will only be updated occasionally and you should use it only for archival purposes.* 
...
**Course content and videos:** There is no formal textbook for this course. The content for the course is located in a wiki, at the website https://publish.obsidian.md/mth225. A playlist of instructional videos is available on Vimeo at https://vimeo.com/showcase/8667148, and individual videos are embedded in the course wiki. A *optional* additional textbook is [Discrete Mathematics: An Open Introduction](http://discrete.openmathbooks.org/dmoi3/dmoi.html) by Oscar Levin. It's free; just click the link. A PDF copy is available for download [here](http://discrete.openmathbooks.org/pdfs/dmoi3-tablet.pdf). Not all course material is included in this textbook, and we may not follow the exact sequence that this book uses. But you are free to use it as a supplement. 

**Course tools:** We will use [Miro](http://miro.com) (an online whiteboard tool) for class work and other purposes. You will also be using Juypyter notebooks on the [Google Colab platform](https://colab.research.google.com/) throughout the course. 
...
**Blackboard and announcements:** Our Blackboard page is at https://lms.gvsu.edu. Announcements will be posted in a weekly "announcement drop" on Friday afternoons, and other times as needed. *Be sure to check announcements, email, and the calendar at least once daily.*
...
2. **Your willingness to ask questions**. The material in MTH 225 can be challenging, and it is certain you will  be lost, confused, and/or stuck at times. **This is not a defect: It means you're doing the course right.** When it happens, don't wait for things to make sense on their own: *Ask questions* of me and your classmates and take action to make sense of the material. 
3. **Your ability to keep current and maintain awareness in the course**. While the pace of MTH 225 is designed to be manageable for everyone, it's easy to fall behind quickly if you don't build an early habit of mindful daily practice, and it's difficult to catch up. To avoid this, check your messages and the calendar at once daily; get to work immediately on assignments; and above all **stay active, ask questions** and **don't procrastinate**.  
