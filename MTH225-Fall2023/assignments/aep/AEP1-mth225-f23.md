...
2. Go to the Google Doc that's been set up for this AEP. There, you'll post your name and your encrypted message (in binary) and your key in a table. (*Note: The link for this page was removed in order to share this assignment publicly without revealing your identities. If you need the link again, please email me for it.*)
