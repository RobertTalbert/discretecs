...
First, the cipher involves the **XOR** operation. This is an  operation, denoted `xor`, that is similar to our logical operators from class. The `xor` works on single bits as follows:
