...
An important method of proof we'll see much more of in a few weeks is called *combinatorial proof*. It is a method of reasoning used when you want to count the number of items in a set, and the approach is to **create a bijective function from one of the sets to the other whose cardinality you already know**. Since a bijection is a one-to-one correspondence between the elements of the domain and range, having a bijection tells you the sets have the same cardinality. This part runs through a basic example that will reappear soon. 
...
1. Write out all the elements of $B_4$. 
