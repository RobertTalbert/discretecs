...
This problem runs through an important sic example that will reappear soon. 
...
1. Look at the sets $\mathbb{N}$ and $\mathbb{Z}$. These are both infinite. Is $\mathbb{N}$ a subset of $\mathbb{Z}$? Or is it the other way around? Or is it neither? Also, are these sets equal? 
