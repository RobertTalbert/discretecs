...
2. **NOTE: The original version of this part had a typo in it. It's now fixed but be sure to use the version that is now here.** Consider the following function $f: \mathbb{N} \rightarrow \mathbb{Z}$ defined this way: 
...
3. Why is the answer to question 4 weird or counterintuitive in light of your answer to question 1?   
