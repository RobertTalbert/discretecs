...
- Because of [De Morgan's Laws](https://publish.obsidian.md/discretecs/Logic/DeMorgan's+Laws) from logic, the negation of the hypothesis of this statement is an "or" statement: Either $a$ is not even *or* $b$ is nod odd. If you put "and" instead of "or", I counted that as a simple error and you get up to two of those before you're downgraded. 
