...
All course materials for MTH 325 are available on GitHub at https://github.com/RobertTalbert/discretecs. The current version is in the folder `MTH325-Fall2024`. Critically important documents will also be on Blackboard in the *Course Documents* folder. 
