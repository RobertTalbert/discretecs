...
- \Put **each** Learning Target you do on a **separate page** with your name at the top. There is no space provided on this form for your work. **Do not put more than one Learning Target on a single page and do not put two Learning Targets different sides of the same page -- turn in only one Learning Target per sheet of paper.** Turn all of your pages in at the end with your name on each. 
